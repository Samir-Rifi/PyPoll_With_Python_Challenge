...
file_to_load = os.path.join("..", "C:\My_Projects\PyPoll_With_Python_Challenge", "election_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join("C:\My_Projects\PyPoll_With_Python_Challenge", "election_analysis.txt")
